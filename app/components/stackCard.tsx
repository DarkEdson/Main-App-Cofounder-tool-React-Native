...
export const StackCard:React.FC<TextBoxProps> = ({
  ...
  return (
    ...
    <XStack>
      <YStack width="70%">
<H4 color={colorText} backgroundColor={colorBg} width={percent} borderRadius={10} textAlign='center'>{tag}</H4>
<H2 color="black"  fontWeight={"bold"}>{title}</H2>
